            ...
            <div className="md:hidden space-y-4">
              {filteredOrders.length > 0 ? (
                filteredOrders.map((order: Order) => (
                  <div key={order.id} className="p-4 hover:bg-gray-50 bg-white rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <div className="mb-3">
                      <div className="font-semibold text-gray-800 text-sm">{order.customer_name}</div>
                      <div className="text-gray-500 text-xs mt-0.5">{order.customer_phone}</div>
                    </div>
                    
                    <div className="flex justify-between items-center mb-4">
                      <div className="text-base font-extrabold text-bridal-maroon">
                    ...
                    <div className="flex flex-wrap items-center justify-between border-t pt-3 gap-2">
                      <span className="text-xs text-gray-500 font-semibold">Actions:</span>
                ...
                <div className="text-center py-12 bg-white rounded-xl border p-4">
