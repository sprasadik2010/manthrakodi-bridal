...
class Settings:
    ...
    def ALLOWED_ORIGINS(self) -> List[str]:
        origins_str = os.getenv("ALLOWED_ORIGINS", "http://localhost:3000,http://127.0.0.1:3000,https://mbridal.onrender.com,https://manthrakodi-bridal.onrender.com, http://localhost:5173, https://mbridal.online")
